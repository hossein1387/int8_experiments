...
/**
 * @brief This option allows to specify the number of MYX devices used for inference by Executable network.
...
/**
 * @brief This options allows to specify that several different executable networks, marked with the same STREAM_ID,
 * must be executed on the same device.
